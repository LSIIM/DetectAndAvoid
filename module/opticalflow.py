...
if __name__ == "__main__":
    ...
    while True:
        ...
        sobel = cv2.Sobel(grey, cv2.CV_8UC1, degree,degree, ksize=ksize,delta=delta)
        prewitt = cv2.filter2D(grey, -2, np.array([[n_prewitt, 0, -n_prewitt], [n_prewitt, 0, -n_prewitt], [n_prewitt, 0, -n_prewitt]]))
        merge_3ch = cv2.merge([grey, sobel, prewitt])
        # Process frame
